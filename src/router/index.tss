...
import userSetting from '../controllers/users/settings';
...
import productImports from '../controllers/warehouse/imports';
import productExports from '../controllers/warehouse/exports';
import productReports from '../controllers/warehouse/reports';
