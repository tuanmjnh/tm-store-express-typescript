...
export interface IProductExports extends Document {
  code: string;
  product: number;
  quantity: number;
  price: number;
...
export const MProductExports = model<IProductExports>('productExports', schema);
export default MProductExports;
